...
- For submission, send back to us your answers in a py file with the following name format: ml_challenge_{NAME}_{LASTNAME}.py
"""
...
#################################################################################
# You don't have to modify the code below this point
